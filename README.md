...
./build-setup.sh fast
```
**Note:** At this time, if you luanch a new EC2 instance of `FPGA Developer AMI`, your option is limited to the latest version which is 1.5.0. FireSim-NVDLA is tested to work on versions 1.4.0 and 1.5.0.
