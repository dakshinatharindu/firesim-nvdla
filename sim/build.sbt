...
lazy val nvdlaip    = project in file("target-rtl/firechip/nvidia-dla-blocks") settings commonSettings dependsOn rocketchip
...
lazy val firesim    = project in file(".") settings commonSettings dependsOn (midas, sifiveip, nvdlaip, testchipip, icenet, boom)
